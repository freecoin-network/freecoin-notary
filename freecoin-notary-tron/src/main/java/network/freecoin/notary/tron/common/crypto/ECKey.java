...
package network.freecoin.notary.tron.common.crypto;
...
import network.freecoin.notary.tron.common.crypto.jce.ECKeyAgreement;
import network.freecoin.notary.tron.common.crypto.jce.ECKeyFactory;
import network.freecoin.notary.tron.common.crypto.jce.ECKeyPairGenerator;
import network.freecoin.notary.tron.common.crypto.jce.ECSignatureFactory;
import network.freecoin.notary.tron.common.crypto.jce.TronCastleProvider;
import network.freecoin.notary.tron.common.utils.BIUtil;
import network.freecoin.notary.tron.common.utils.ByteUtil;
...
public class ECKey implements Serializable {
  ...
  public static byte[] computeAddress(byte[] pubBytes) {
    ...
    return network.freecoin.notary.tron.common.crypto.Hash.sha3omit12(
