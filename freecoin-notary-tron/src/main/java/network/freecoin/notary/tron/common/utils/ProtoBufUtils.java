...
import network.freecoin.notary.tron.protos.Protocol.InternalTransaction;
import network.freecoin.notary.tron.protos.Protocol.ResourceReceipt;
...
//    result += "\n";
    ...
    result += WalletUtil
        .encode58Check(transactionInfo.getContractAddress().toByteArray());
//    result += "\n";
//    result += "logList: ";
//    result += "\n";
