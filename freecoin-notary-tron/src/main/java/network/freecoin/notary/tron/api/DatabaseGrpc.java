...
public final class DatabaseGrpc {
  ...
  public static final io.grpc.MethodDescriptor<GrpcAPI.EmptyMessage,
      network.freecoin.notary.tron.protos.Protocol.DynamicProperties> METHOD_GET_DYNAMIC_PROPERTIES = getGetDynamicPropertiesMethod();

  private static volatile io.grpc.MethodDescriptor<GrpcAPI.EmptyMessage,
      network.freecoin.notary.tron.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<GrpcAPI.EmptyMessage,
      network.freecoin.notary.tron.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod() {
    io.grpc.MethodDescriptor<GrpcAPI.EmptyMessage, network.freecoin.notary.tron.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod;
      ...
      synchronized (DatabaseGrpc.class) {
        if ((getGetDynamicPropertiesMethod = DatabaseGrpc.getGetDynamicPropertiesMethod) == null) {
          DatabaseGrpc.getGetDynamicPropertiesMethod = getGetDynamicPropertiesMethod = 
              io.grpc.MethodDescriptor.<GrpcAPI.EmptyMessage, network.freecoin.notary.tron.protos.Protocol.DynamicProperties>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  GrpcAPI.EmptyMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  network.freecoin.notary.tron.protos.Protocol.DynamicProperties.getDefaultInstance()))
  ...
  public static abstract class DatabaseImplBase implements io.grpc.BindableService {
    ...
    public void getDynamicProperties(GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<network.freecoin.notary.tron.protos.Protocol.DynamicProperties> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                GrpcAPI.EmptyMessage,
                network.freecoin.notary.tron.protos.Protocol.DynamicProperties>(
  ...
  public static final class DatabaseBlockingStub extends io.grpc.stub.AbstractStub<DatabaseBlockingStub> {
    ...
    /**
     */
    public network.freecoin.notary.tron.protos.Protocol.DynamicProperties getDynamicProperties(GrpcAPI.EmptyMessage request) {
      return blockingUnaryCall(
  ...
  public static final class DatabaseFutureStub extends io.grpc.stub.AbstractStub<DatabaseFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<network.freecoin.notary.tron.protos.Protocol.DynamicProperties> getDynamicProperties(
        GrpcAPI.EmptyMessage request) {
      return futureUnaryCall(
