...
public final class WalletExtensionGrpc {
      ...
      synchronized (WalletExtensionGrpc.class) {
        if ((getGetTransactionsFromThisMethod = WalletExtensionGrpc.getGetTransactionsFromThisMethod) == null) {
          WalletExtensionGrpc.getGetTransactionsFromThisMethod = getGetTransactionsFromThisMethod = 
              io.grpc.MethodDescriptor.<GrpcAPI.AccountPaginated, GrpcAPI.TransactionList>newBuilder()
      ...
      synchronized (WalletExtensionGrpc.class) {
        if ((getGetTransactionsFromThis2Method = WalletExtensionGrpc.getGetTransactionsFromThis2Method) == null) {
          WalletExtensionGrpc.getGetTransactionsFromThis2Method = getGetTransactionsFromThis2Method = 
              io.grpc.MethodDescriptor.<GrpcAPI.AccountPaginated, GrpcAPI.TransactionListExtention>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  GrpcAPI.AccountPaginated.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  GrpcAPI.TransactionListExtention.getDefaultInstance()))
  ...
  public static abstract class WalletExtensionImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getTransactionsFromThis(GrpcAPI.AccountPaginated request,
     ...
     * </pre>
     */
    public void getTransactionsFromThis2(GrpcAPI.AccountPaginated request,
     ...
     * </pre>
     */
    public void getTransactionsToThis(GrpcAPI.AccountPaginated request,
        io.grpc.stub.StreamObserver<GrpcAPI.TransactionList> responseObserver) {
     ...
     * </pre>
     */
    public void getTransactionsToThis2(GrpcAPI.AccountPaginated request,
        io.grpc.stub.StreamObserver<GrpcAPI.TransactionListExtention> responseObserver) {
  ...
  public static final class WalletExtensionFutureStub extends io.grpc.stub.AbstractStub<WalletExtensionFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<GrpcAPI.TransactionList> getTransactionsFromThis(
        GrpcAPI.AccountPaginated request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_TRANSACTIONS_FROM_THIS:
          serviceImpl.getTransactionsFromThis((GrpcAPI.AccountPaginated) request,
              (io.grpc.stub.StreamObserver<GrpcAPI.TransactionList>) responseObserver);
          break;
        case METHODID_GET_TRANSACTIONS_FROM_THIS2:
          serviceImpl.getTransactionsFromThis2((GrpcAPI.AccountPaginated) request,
              (io.grpc.stub.StreamObserver<GrpcAPI.TransactionListExtention>) responseObserver);
          break;
        case METHODID_GET_TRANSACTIONS_TO_THIS:
          serviceImpl.getTransactionsToThis((GrpcAPI.AccountPaginated) request,
              (io.grpc.stub.StreamObserver<GrpcAPI.TransactionList>) responseObserver);
          break;
        case METHODID_GET_TRANSACTIONS_TO_THIS2:
          serviceImpl.getTransactionsToThis2((GrpcAPI.AccountPaginated) request,
              (io.grpc.stub.StreamObserver<GrpcAPI.TransactionListExtention>) responseObserver);
          break;
        default:
